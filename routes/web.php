...
Route::middleware([PreventBackHistory4::class])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['auth', CheckCompanyStatus::class])->group(function () {
            ...
            Route::get('/sales/dte/{codigo}', [SaleController::class, 'show'])
                ->name('dte.public');
            ...
            Route::get('/stores/{store}/sales/{sale}/download-dte', [ReciboController::class, 'downloadDTE'])
                ->name('dte-download');
            Route::get('/stores/{store}/creditnotes/{creditNote}/download-dte-nc', [ReciboController::class, 'downloadDTENC'])
                ->name('dte-download-nc');
            ...
            Route::get('/catalogos/municipios/{departamentoId}', [MunicipioController::class, 'byDepartamento'])
                ->name('municipios.byDepartamento');
            ...
            Route::get('/dte/{codigo}', [CreditNoteController::class, 'show'])
                ->name('dte.public.nc');
            ...
            //Email Test OCI
            Route::post('/stores/{store}/creditnotes/{creditNote}/send-email-nc', [\App\Http\Controllers\OCIController::class, 'emailSendNc'])
                ->name('stores.email.send.nc');
        });
    });
});
