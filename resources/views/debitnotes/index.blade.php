...
<div class="gestok-table-card">
    ...
    <div class="gestok-table-body">
        @if($debitNotes->isEmpty())
            <p class="no-data">No hay notas de Debito registradas.</p>
        @else
            <table>
                <thead>
                    <tr>
                    ...
                    @foreach($debitNotes as $debitnote)
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <form action="{{ route('stores.debitnotes.destroy', [$store->id, $debitnote->id]) }}" method="POST" onsubmit="return confirm('¿Eliminar esta nota de Debito?');">
                                    @csrf
                                    @method('DELETE')
