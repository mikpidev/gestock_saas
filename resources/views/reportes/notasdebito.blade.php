    ...
    <div class="documento">
        ...
        <div class="totales">
            ...
            <div class="fila-total">
                <span>IVA:</span>
                <span>${{ number_format($resumen['tributos'][0]['valor'] ?? 0, 2) }}</span>
            </div>

            <div class="fila-total">
                <span>SUBTOTAL:</span>
                <span>${{ number_format($resumen['subTotal'], 2) }}</span>
            </div>

            <div class="fila-total">
                <strong>TOTAL:</strong>
                <strong>${{ number_format($resumen['montoTotalOperacion'], 2) }}</strong>
            </div>
