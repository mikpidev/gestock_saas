<div id="dte-print-area">
    ...
    <div class="documento">
        ...
        <table class="tabla-productos">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>${{ number_format($item['montoDescu'] ?? 0, 2) }}</td>
                    <td>${{ number_format($item['ventaNoSuj'] ?? 0, 2) }}</td>
                    <td>${{ number_format($item['ventaExenta'] ?? 0, 2) }}</td>
        ...
        <table class="tabla-totales">
            ...
            <tr>
                <th colspan="3" style="text-align:right;">Monto global Desc., Rebajas y otros a ventas no sujetas:</th>
                <td><span>${{ number_format($resumen['descuNoSuj'] ?? 0, 2) }} </span></td>
            </tr>
            <tr>
                <th colspan="3" style="text-align:right;">Monto global Desc., Rebajas y otros a ventas Exentas: </th>
                <td><span>${{ number_format($resumen['descuExenta'] ?? 0, 2) }} </span></td>
            </tr>
            <tr>
                <th colspan="3" style="text-align:right;">Monto global Desc., Rebajas y otros a ventas gravadas: </th>
